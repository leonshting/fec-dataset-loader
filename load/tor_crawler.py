...
class TorCrawler(object):
    ...
    def _run_tests(self):
        ...
        if self.use_tor:
            ...
            tor_html = self._check_convert("https://check.torproject.org")
    ...
    def _check_convert(self, url, headers=None, timeout=None):
    ...
    def get(self, url, headers=None, timeout=None):
        ...
        res = self._check_convert(url, headers, timeout=timeout)
        self._update_count()
        return res
